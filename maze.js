const a = 20;               //  Сторона клетки (в пикселях)
...
const newest = 60,          //  Шанс выбора продолжения из последней добавленной клетки(%)
    random = 40;            //  Шанс выбора продолжения из случайной клетки(%)
